    ...
    <div class=" container-fluid" >
        ...
        <div class="">
            ...
            <div class="footer" style="display: block">
                <ul class="pagination " >
                    <li><a href="classify?pageNo=${pageInfo.firstPage}">首页</a></li>
                    <li><a href="classify?pageNo=${pageInfo.pageNum-1}">&laquo</a></li>
                    <c:forEach items="${pageInfo.navigatepageNums}"
                        ...
                        <c:if test="${pagenum!=pageInfo.pageNum}">
                            <li>
                                <a href="classify?pageNo=${pagenum}">${pagenum}</a>
                            </li>
                        </c:if>
                    </c:forEach>
                    <li><a href="classify?pageNo=${pageInfo.pageNum+1}">&raquo</a></li>
                    <li><a href="classify?pageNo=${pageInfo.lastPage}">尾页</a></li>
                </ul>
            </div>
        </div>
